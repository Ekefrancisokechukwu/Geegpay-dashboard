...
const Header = () => {
  ...
  return (
    <header className="flex lg:flex-row flex-col-reverse sticky gap-y-3 top-0 bg-primary-foreground/60 backdrop-blur dark:bg-neutral-950/55 z-30 lg:items-center justify-between py-4 px-6 border-b">
      <div className="flex items-center gap-x-3">
        <h1 className="lg:text-[1.25rem] text-[.8rem]  font-semibold">
          Dashboard
        </h1>
        <span className="hidden max-[570px]:block">/</span>
        <h4 className="md:text-[0.875rem] hidden max-[570px]:block text-[.6rem] font-medium  ">
          Nov 15,23
        </h4>
      </div>

      <div className="flex justify-between items-center gap-x-2 ">
        <div className="flex gap-x-10 max-[375px]:gap-x-5 items-center ">
          <div className="flex relative items-center">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="rounded-[1.5rem] max-[453px]:w-[8rem] placeholder:text-sm focus:outline-slate-200 py-2 pl-14 pr-3 border"
            />
          </div>

          <div className="flex items-center gap-x-2 max-[570px]:hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
            ...
            <h4 className="text-[0.875rem] font-medium xl:block hidden">
              November 15, 2023
            </h4>
            <h4 className="md:text-[0.875rem] text-[.6rem] font-medium xl:hidden ">
              Nov 15,23
            </h4>
          </div>

          <button className="flex-shrink-0 md:h-[2.5rem] md:w-[2.5rem] w-[1.8rem] h-[1.8rem] border border-[#DADDDD] grid place-items-center rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <div className="flex flex-shrink-0 cursor-pointer border border-[#DADDDD] py-1 px-1.5 rounded-[1.75rem] items-center xl:gap-x-4 gap-x-2">
            <figure>
              <Image
                src={"/img/user.png"}
                alt="'user"
                width={38}
                height={38}
                className="md:w-[38px] md:h-[38px] w-[25px] h-[25px]"
              />
            </figure>
            <div className="xl:block hidden">
              <h2 className="text-[1rem] font-[400]">Justin Bergson</h2>
              <p className="text-[#787486] text-[ 0.875rem]">
                Justin@gmail.com
              </p>
            </div>
        ...
        <button onClick={handleOpenNav} className="md:hidden block">
          <Menu />
        </button>
      </div>
