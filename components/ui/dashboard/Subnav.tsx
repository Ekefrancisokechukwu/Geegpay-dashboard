...
const Subnav = ({ isOpen }: Subnav) => {
  return (
    <div
      className={cn(
        "absolute md:hidden transition-all duration-200 transform shadow-xl flex items-center gap-x-4  w-full bg-white dark:bg-primary-foreground left-0 px-3 py-2 top-full",
        isOpen
    ...
    >
      ...
      <ScrollArea className="w-[40rem]">
        <div className="flex items-center">
          <ul className="flex items-center ">
            <li>
              <Link
                href={"#"}
                className="px-[1rem] py-2 relative  inline-block"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <li>
              <Link href={"#"} className="px-[2rem] py-2  inline-block">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="flex ">
            <button className="inline-block px-[2rem] py-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
