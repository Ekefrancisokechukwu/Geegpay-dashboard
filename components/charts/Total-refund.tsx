...
const TotalRefund = () => {
  ...
  return (
    <div className="w-full flex overflow-hidden flex-col gap-y-[0.625rem] rounded-[0.875rem] bg-white dark:bg-primary-foreground border p-3 border-[#EDF2F7] dark:border-gray-100/45">
